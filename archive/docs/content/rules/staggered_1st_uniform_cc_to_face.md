---
title: "staggered_1st_uniform_cc_to_face"
slug: "staggered_1st_uniform_cc_to_face"
...
description: "Auto-generated catalog entry for the staggered_1st_uniform_cc_to_face rule (finite_difference, grid family arakawa). The discrete operator is pretty-printed directly from the rule's replacement AST."
---
...
```text
out[$x] = −1/h·index($u, $x + −1) + 1/h·index($u, $x)
```
