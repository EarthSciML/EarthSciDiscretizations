---
title: "centered_4th_uniform"
slug: "centered_4th_uniform"
families: "finite_difference"
grid_families: "cartesian"
rule_kinds: "scheme"
accuracy: "O(dx^4)"
applies_to: "grad($u), dim=$x"
rule_path: "discretizations/finite_difference/centered_4th_uniform.json"
description: "Auto-generated catalog entry for the centered_4th_uniform rule (finite_difference, grid family cartesian). The discrete operator is pretty-printed directly from the rule's replacement AST."
---
...
```text
out[$x] = (8·(index($u, $x + 1) − index($u, $x − 1)) − (index($u, $x + 2) − index($u, $x − 2)))/(12·dx)
```

Source: [`discretizations/finite_difference/centered_4th_uniform.json`]({{< param repoURL >}}/blob/main/discretizations/finite_difference/centered_4th_uniform.json).
