...
Run from the repo root:
    julia --project=. tests/conformance/discretization/rect_1d_advection_upwind_periodic/regenerate_golden.jl
...
# (Shared logic with rect_1d_advection_centered_periodic; both use the same
#  evaluator against the replacement form produced by lower_stencil_to_replacement.)
# ---------------------------------------------------------------------------
