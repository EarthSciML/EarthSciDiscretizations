---
title: "centered_6th_uniform"
slug: "centered_6th_uniform"
families: "finite_difference"
grid_families: "cartesian"
rule_kinds: "scheme"
accuracy: "O(dx^6)"
applies_to: "grad($u), dim=$x"
rule_path: "discretizations/finite_difference/centered_6th_uniform.json"
description: "Auto-generated catalog entry for the centered_6th_uniform rule (finite_difference, grid family cartesian). The discrete operator is pretty-printed directly from the rule's replacement AST."
---
...
```text
out[$x] = (45·(index($u, $x + 1) − index($u, $x − 1)) − 9·(index($u, $x + 2) − index($u, $x − 2)) + index($u, $x + 3) − index($u, $x − 3))/(60·dx)
```

Source: [`discretizations/finite_difference/centered_6th_uniform.json`]({{< param repoURL >}}/blob/main/discretizations/finite_difference/centered_6th_uniform.json).
